...
export default function Home() {
  ...
  const stats = [
    { 
      ...
      change: "+4.2%", 
      icon: Milestone,
      description: "Total de quilômetros acumulados nos últimos 7 dias."
    },
    { 
      label: "VDOT Atual", 
      ...
      change: "+0.8", 
      icon: Zap,
      description: "Seu índice de performance baseado na metodologia de Jack Daniels."
    },
    { 
      label: "FC Média", 
      value: "142 bpm", 
      change: "-2.1%", 
      icon: Activity,
      description: "Média de batimentos por minuto durante as sessões de treino."
    },
    { 
      ...
      change: "Ideal", 
      icon: Clock,
      description: "Nível de prontidão física para o próximo estímulo de carga."
    },
  ];
      ...
      <TooltipProvider>
        <div className="space-y-8 animate-in fade-in duration-500">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {stats.map((stat) => (
              <Card key={stat.label} className={cn("bg-card border-border hover:border-accent/50 transition-colors shadow-sm relative group")}>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Info className="size-3 text-muted-foreground/50 cursor-help hover:text-primary transition-colors" />
                      </TooltipTrigger>
